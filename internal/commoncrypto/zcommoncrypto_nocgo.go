...
func CCCrypt(op CCOperation, alg CCAlgorithm, options CCOptions, key []byte, iv []byte, dataIn []byte, dataOut []byte, dataOutMoved *int) CCCryptorStatus {
	r0, _ := syscallN(0, _mkcgo_CCCrypt_trampoline_addr, uintptr(op), uintptr(alg), uintptr(options), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(key)))), uintptr(len(key)), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(iv)))), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(dataIn)))), uintptr(len(dataIn)), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(dataOut)))), uintptr(len(dataOut)), uintptr(mkcgoEscapePtr(unsafe.Pointer(dataOutMoved))))
...
func CCCryptorCreate(op CCOperation, alg CCAlgorithm, options CCOptions, key []byte, iv []byte, cryptorRef *CCCryptorRef) CCCryptorStatus {
	r0, _ := syscallN(0, _mkcgo_CCCryptorCreate_trampoline_addr, uintptr(op), uintptr(alg), uintptr(options), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(key)))), uintptr(len(key)), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(iv)))), uintptr(mkcgoEscapePtr(unsafe.Pointer(cryptorRef))))
	return CCCryptorStatus(r0)
}
...
func CCCryptorCreateWithMode(op CCOperation, mode CCMode, alg CCAlgorithm, padding CCPadding, iv []byte, key []byte, tweak []byte, numRounds int32, options CCModeOptions, cryptorRef *CCCryptorRef) CCCryptorStatus {
	...
	if runtime.GOOS == "darwin" && runtime.GOARCH == "arm64" {
		...
		r0, _ = syscallN(0, _mkcgo_CCCryptorCreateWithMode_trampoline_addr, uintptr(op), uintptr(mode), uintptr(alg), uintptr(padding), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(iv)))), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(key)))), uintptr(len(key)), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(tweak)))), uintptr(len(tweak)), uintptr(numRounds), uintptr(options), uintptr(mkcgoEscapePtr(unsafe.Pointer(cryptorRef))))
	}
	return CCCryptorStatus(r0)
}
...
func CCCryptorReset(cryptorRef CCCryptorRef, iv []byte) CCCryptorStatus {
	r0, _ := syscallN(0, _mkcgo_CCCryptorReset_trampoline_addr, uintptr(cryptorRef), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(iv)))))
	return CCCryptorStatus(r0)
}
...
func CCCryptorUpdate(cryptorRef CCCryptorRef, dataIn []byte, dataOut []byte, dataOutMoved *int) CCCryptorStatus {
	r0, _ := syscallN(0, _mkcgo_CCCryptorUpdate_trampoline_addr, uintptr(cryptorRef), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(dataIn)))), uintptr(len(dataIn)), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(dataOut)))), uintptr(len(dataOut)), uintptr(mkcgoEscapePtr(unsafe.Pointer(dataOutMoved))))
	return CCCryptorStatus(r0)
}
...
func CCKeyDerivationPBKDF(algorithm CCPBKDFAlgorithm, password []byte, salt []uint8, prf CCPseudoRandomAlgorithm, rounds uint32, derivedKey []uint8) CCCryptorStatus {
	r0, _ := syscallN(0, _mkcgo_CCKeyDerivationPBKDF_trampoline_addr, uintptr(algorithm), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(password)))), uintptr(len(password)), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(salt)))), uintptr(len(salt)), uintptr(prf), uintptr(rounds), uintptr(mkcgoEscapePtr(unsafe.Pointer(unsafe.SliceData(derivedKey)))), uintptr(len(derivedKey)))
	return CCCryptorStatus(r0)
}
