...
int _mkcgo_go_decapsulateMLKEM1024(const uint8_t*, const uint8_t*, uint8_t*);
int _mkcgo_go_decapsulateMLKEM768(const uint8_t*, const uint8_t*, uint8_t*);
...
int _mkcgo_go_deriveEncapsulationKeyMLKEM1024(const uint8_t*, uint8_t*);
int _mkcgo_go_deriveEncapsulationKeyMLKEM768(const uint8_t*, uint8_t*);
int _mkcgo_go_encapsulateMLKEM1024(const uint8_t*, uint8_t*, uint8_t*);
int _mkcgo_go_encapsulateMLKEM768(const uint8_t*, uint8_t*, uint8_t*);
...
int _mkcgo_go_generateKeyMLKEM1024(uint8_t*);
int _mkcgo_go_generateKeyMLKEM768(uint8_t*);
