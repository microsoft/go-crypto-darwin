...
#ifndef CRYPTOKITSRC_SWIFT_H
#define CRYPTOKITSRC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CryptoKitSrc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_EXTERN NSInteger decryptAESGCM(uint8_t const * _Nonnull keyPointer, NSInteger keyLength, uint8_t const * _Nonnull dataPointer, NSInteger dataLength, uint8_t const * _Nonnull noncePointer, NSInteger nonceLength, uint8_t const * _Nonnull aadPointer, NSInteger aadLength, uint8_t const * _Nonnull tagPointer, NSInteger tagLength, uint8_t * _Nonnull outPointer, NSInteger * _Nonnull outLength) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN NSInteger encryptAESGCM(uint8_t const * _Nonnull keyPointer, NSInteger keyLength, uint8_t const * _Nonnull dataPointer, NSInteger dataLength, uint8_t const * _Nonnull noncePointer, NSInteger nonceLength, uint8_t const * _Nonnull aadPointer, NSInteger aadLength, uint8_t * _Nonnull cipherTextPointer, NSInteger cipherTextLength, uint8_t * _Nonnull tagPointer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN NSInteger expandHKDF(int32_t hashFunction, uint8_t const * _Nonnull prkPointer, NSInteger prkLength, uint8_t const * _Nonnull infoPointer, NSInteger infoLength, uint8_t * _Nonnull derivedKeyPointer, NSInteger derivedKeyLength) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN NSInteger extractHKDF(int32_t hashFunction, uint8_t const * _Nonnull secretPointer, NSInteger secretLength, uint8_t const * _Nonnull saltPointer, NSInteger saltLength, uint8_t * _Nonnull prkPointer, NSInteger prkLength) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN void generateKeyEd25519(uint8_t * _Nonnull keyPointer) SWIFT_NOEXCEPT;


SWIFT_EXTERN NSInteger newPrivateKeyEd25519FromSeed(uint8_t * _Nonnull keyPointer, uint8_t const * _Nonnull seedPointer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN NSInteger newPublicKeyEd25519(uint8_t * _Nonnull keyPointer, uint8_t const * _Nonnull pubPointer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN NSInteger signEd25519(uint8_t const * _Nonnull privateKeyPointer, uint8_t const * _Nullable messagePointer, NSInteger messageLength, uint8_t * _Nullable sigBuffer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN NSInteger verifyEd25519(uint8_t const * _Nonnull publicKeyPointer, uint8_t const * _Nullable messagePointer, NSInteger messageLength, uint8_t const * _Nullable sigPointer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("CryptoKitSrc", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace CryptoKitSrc SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("CryptoKitSrc") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN ptrdiff_t decryptAESGCM(uint8_t const * _Nonnull keyPointer, ptrdiff_t keyLength, uint8_t const * _Nonnull dataPointer, ptrdiff_t dataLength, uint8_t const * _Nonnull noncePointer, ptrdiff_t nonceLength, uint8_t const * _Nonnull aadPointer, ptrdiff_t aadLength, uint8_t const * _Nonnull tagPointer, ptrdiff_t tagLength, uint8_t * _Nonnull outPointer, ptrdiff_t * _Nonnull outLength) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t encryptAESGCM(uint8_t const * _Nonnull keyPointer, ptrdiff_t keyLength, uint8_t const * _Nonnull dataPointer, ptrdiff_t dataLength, uint8_t const * _Nonnull noncePointer, ptrdiff_t nonceLength, uint8_t const * _Nonnull aadPointer, ptrdiff_t aadLength, uint8_t * _Nonnull cipherTextPointer, ptrdiff_t cipherTextLength, uint8_t * _Nonnull tagPointer) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t expandHKDF(int32_t hashFunction, uint8_t const * _Nonnull prkPointer, ptrdiff_t prkLength, uint8_t const * _Nonnull infoPointer, ptrdiff_t infoLength, uint8_t * _Nonnull derivedKeyPointer, ptrdiff_t derivedKeyLength) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t extractHKDF(int32_t hashFunction, uint8_t const * _Nonnull secretPointer, ptrdiff_t secretLength, uint8_t const * _Nonnull saltPointer, ptrdiff_t saltLength, uint8_t * _Nonnull prkPointer, ptrdiff_t prkLength) SWIFT_NOEXCEPT;
SWIFT_EXTERN void generateKeyEd25519(uint8_t * _Nonnull keyPointer) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t newPrivateKeyEd25519FromSeed(uint8_t * _Nonnull keyPointer, uint8_t const * _Nonnull seedPointer) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t newPublicKeyEd25519(uint8_t * _Nonnull keyPointer, uint8_t const * _Nonnull pubPointer) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t signEd25519(uint8_t const * _Nonnull privateKeyPointer, uint8_t const * _Nullable messagePointer, ptrdiff_t messageLength, uint8_t * _Nullable sigBuffer) SWIFT_NOEXCEPT;
SWIFT_EXTERN ptrdiff_t verifyEd25519(uint8_t const * _Nonnull publicKeyPointer, uint8_t const * _Nullable messagePointer, ptrdiff_t messageLength, uint8_t const * _Nullable sigPointer) SWIFT_NOEXCEPT;
...
SWIFT_INLINE_THUNK swift::Int decryptAESGCM(uint8_t const * _Nonnull keyPointer, swift::Int keyLength, uint8_t const * _Nonnull dataPointer, swift::Int dataLength, uint8_t const * _Nonnull noncePointer, swift::Int nonceLength, uint8_t const * _Nonnull aadPointer, swift::Int aadLength, uint8_t const * _Nonnull tagPointer, swift::Int tagLength, uint8_t * _Nonnull outPointer, swift::Int * _Nonnull outLength) noexcept SWIFT_SYMBOL("c:(cm)decryptAESGCMWithKeyPointer:keyLength:dataPointer:dataLength:noncePointer:nonceLength:aadPointer:aadLength:tagPointer:tagLength:outPointer:outLength:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::decryptAESGCM(keyPointer, keyLength, dataPointer, dataLength, noncePointer, nonceLength, aadPointer, aadLength, tagPointer, tagLength, outPointer, outLength);
}


SWIFT_INLINE_THUNK swift::Int encryptAESGCM(uint8_t const * _Nonnull keyPointer, swift::Int keyLength, uint8_t const * _Nonnull dataPointer, swift::Int dataLength, uint8_t const * _Nonnull noncePointer, swift::Int nonceLength, uint8_t const * _Nonnull aadPointer, swift::Int aadLength, uint8_t * _Nonnull cipherTextPointer, swift::Int cipherTextLength, uint8_t * _Nonnull tagPointer) noexcept SWIFT_SYMBOL("c:(cm)encryptAESGCMWithKeyPointer:keyLength:dataPointer:dataLength:noncePointer:nonceLength:aadPointer:aadLength:cipherTextPointer:cipherTextLength:tagPointer:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::encryptAESGCM(keyPointer, keyLength, dataPointer, dataLength, noncePointer, nonceLength, aadPointer, aadLength, cipherTextPointer, cipherTextLength, tagPointer);
}


SWIFT_INLINE_THUNK swift::Int expandHKDF(int32_t hashFunction, uint8_t const * _Nonnull prkPointer, swift::Int prkLength, uint8_t const * _Nonnull infoPointer, swift::Int infoLength, uint8_t * _Nonnull derivedKeyPointer, swift::Int derivedKeyLength) noexcept SWIFT_SYMBOL("c:(cm)expandHKDFWithHashFunction:prkPointer:prkLength:infoPointer:infoLength:derivedKeyPointer:derivedKeyLength:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::expandHKDF(hashFunction, prkPointer, prkLength, infoPointer, infoLength, derivedKeyPointer, derivedKeyLength);
}


SWIFT_INLINE_THUNK swift::Int extractHKDF(int32_t hashFunction, uint8_t const * _Nonnull secretPointer, swift::Int secretLength, uint8_t const * _Nonnull saltPointer, swift::Int saltLength, uint8_t * _Nonnull prkPointer, swift::Int prkLength) noexcept SWIFT_SYMBOL("c:(cm)extractHKDFWithHashFunction:secretPointer:secretLength:saltPointer:saltLength:prkPointer:prkLength:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::extractHKDF(hashFunction, secretPointer, secretLength, saltPointer, saltLength, prkPointer, prkLength);
}


SWIFT_INLINE_THUNK void generateKeyEd25519(uint8_t * _Nonnull keyPointer) noexcept SWIFT_SYMBOL("c:(cm)generateKeyEd25519WithKeyPointer:") {
  _impl::generateKeyEd25519(keyPointer);
}


SWIFT_INLINE_THUNK swift::Int newPrivateKeyEd25519FromSeed(uint8_t * _Nonnull keyPointer, uint8_t const * _Nonnull seedPointer) noexcept SWIFT_SYMBOL("c:(cm)newPrivateKeyEd25519FromSeedWithKeyPointer:seedPointer:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::newPrivateKeyEd25519FromSeed(keyPointer, seedPointer);
}


SWIFT_INLINE_THUNK swift::Int newPublicKeyEd25519(uint8_t * _Nonnull keyPointer, uint8_t const * _Nonnull pubPointer) noexcept SWIFT_SYMBOL("c:(cm)newPublicKeyEd25519WithKeyPointer:pubPointer:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::newPublicKeyEd25519(keyPointer, pubPointer);
}


SWIFT_INLINE_THUNK swift::Int signEd25519(uint8_t const * _Nonnull privateKeyPointer, uint8_t const * _Nullable messagePointer, swift::Int messageLength, uint8_t * _Nullable sigBuffer) noexcept SWIFT_SYMBOL("c:(cm)signEd25519WithPrivateKeyPointer:messagePointer:messageLength:sigBuffer:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::signEd25519(privateKeyPointer, messagePointer, messageLength, sigBuffer);
}


SWIFT_INLINE_THUNK swift::Int verifyEd25519(uint8_t const * _Nonnull publicKeyPointer, uint8_t const * _Nullable messagePointer, swift::Int messageLength, uint8_t const * _Nullable sigPointer) noexcept SWIFT_SYMBOL("c:(cm)verifyEd25519WithPublicKeyPointer:messagePointer:messageLength:sigPointer:") SWIFT_WARN_UNUSED_RESULT {
  return _impl::verifyEd25519(publicKeyPointer, messagePointer, messageLength, sigPointer);
}


} // namespace CryptoKitSrc
